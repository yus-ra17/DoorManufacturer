...
const Footer1 = () => {
              ...
              <div className="cs_footer_col">
                <div className="cs_footer_widget">
                  ...
                  <div className="cs_text_widget">
                    <p>At Charoteco Doors, we specialize in crafting high-quality, eco-friendly doors that blend durability, style, and sustainability. Our doors are designed to enhance homes and commercial spaces while promoting a greener future.</p>
                  </div>
              ...
              <div className="cs_footer_col">
                <div className="cs_footer_widget">
                  ...
                  <ul className="cs_footer_menu">
                    ...
                    <li>
                      <Link href="/service/service-details">Waterproof & Fire Retardant</Link>
                    </li>
                    <li>
                      <Link href="/service/service-details">Soundproof</Link>
                    </li>
                    <li>
                      <Link href="/service/service-details">Termite & Rot Resistant </Link>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="cs_footer_widget">
                  ...
                  <ul className="cs_footer_contact_list cs_mp_0">
                    ...
                    <i className="bi bi-telephone-fill"></i>
                      <a href="tel:+251-90-868-6868">+251-90-868-6868
                      </a> <br/>
  ...
  Copyright © {new Date().getFullYear()} <a href="#">charotecodoors</a>. All Rights Reserved.
</div>
